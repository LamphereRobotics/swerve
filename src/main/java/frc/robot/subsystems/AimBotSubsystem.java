...
public class AimBotSubsystem extends ProfiledPIDSubsystem {
	...
	public AimBotSubsystem() {
		super(
				...
				new ProfiledPIDController(
						...
						new TrapezoidProfile.Constraints(ArmConfig.kMaxDegreesPerSecond,
								ArmConfig.kMaxDegreesPerSecondSquared)),
		...
		m_encoder.getConfigurator()
				.apply(new MagnetSensorConfigs().withSensorDirection(ArmConfig.kAimyCancoderDirection));
	...
	public void periodic() {
		...
		SmartDashboard.putNumber("aim-bot-left-voltage", m_leftMotor.getAppliedOutput() * m_leftMotor.getBusVoltage());
		SmartDashboard.putNumber("aim-bot-right-voltage",
		...
		SmartDashboard.putNumber("aim-bot-desired-position", m_controller.getSetpoint().position);
		SmartDashboard.putNumber("aim-bot-desired-velocity", m_controller.getSetpoint().velocity);
	}
