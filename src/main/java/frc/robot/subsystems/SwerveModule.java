...
public class SwerveModule {
  ...
  public SwerveModule(
    ...
    m_driveEncoder.setVelocityConversionFactor(Constants.DriveConstants.kDriveScale / 50);
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    // Calculate the turning motor output from the turning PID controller.
    m_driveMotor.set(driveOutput + state.speedMetersPerSecond / DriveConstants.kMaxSpeedMetersPerSecond);
